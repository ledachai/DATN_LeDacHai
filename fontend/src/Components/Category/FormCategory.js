...
class FormCategory extends Component {
  ...
  render() {
    ...
    if (this.props.showFormCategory === false) return null;
    return (
      <div className="card">
        <div className="card-body">
          ...
          <form>
            <div className="row mb-3">
              <label htmlFor="inputCateName" className="col-sm-2 col-form-label">Tên hãng</label>
            ...
            <div className="row mb-3">
              <label htmlFor="inputCateDescibe" className="col-sm-2 col-form-label">Mô tả</label>
              <div className="col-sm-6">
                <textarea type="text-area" className="form-control" id="inputCateDescibe" value={this.props.cate_Descibe}
                  onChange={(event) =>
            ...
            <div className="flex_right">
              ...
              <button type="button" className="ms-btn ms-btn_icon" onClick={() => this.validateCategoryForm()}><i className="far fa-save icon"/>Thêm</button>
            </div>
          </form>
        </div>
      </div>
