...
class OrderKH extends Component {
    constructor() {
        super();
        this.state = {
            Order: [],
            order_ID: '',
            defaultUrl: "https://localhost:5001/api/V1/Order?Peo_ID=",
            urlUpdate: "https://localhost:5001/api/V1/Order?Order_ID=",
        }
    }
    getConfigToken() {
        let config = {
    ...
    updateStatus = (order_ID) => {
        var url = this.state.urlUpdate + order_ID;
        let config = this.getConfigToken();
        axios
            .put(url,{
            ...
            .catch(error => {
                Swal.fire(
                    'Đơn hàng đang giao hoặc đã hủy!',
    ...
    renderOrder = () =>{
        return this.state.Order.map((data, index) => {
            return (
                <div className="card rounded-3 mb-4" key={data.order_ID}>
                    ...
                    <div className="row d-flex justify-content-between align-items-center">
                        ...
                        <p><span className="text-muted">Ngày đặt: </span>{this.formatDate(data.order_Date)}</p>
                        </div>
                        <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                        <h5 className="mb-0">{this.formatMoney(data.cart_Pay)} đ</h5>
                        </div>
                        <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                        <h5 className="mb-0">{data.order_Status}</h5>
                        </div>
                        <div className="col-md-1 col-lg-1 col-xl-1 text-end">
                            <div className="flex-center">
                                <button type="button" class="btn btn-danger btn-sm" onClick={()=> this.showUpdateConfirmAlert(data)}><i className="fas fa-x fa-lg" /></button>
                            </div>
                        </div>
                    </div>
                    </div>
                        ...
                        <div className="container h-100 py-5" style={{width:'100%'}}>
                            <div className="row d-flex justify-content-center align-items-center h-100">
                                <div className="d-flex justify-content-between align-items-center mb-4">
                                    <h3 className="fw-normal mb-0 text-black">Thông tin đơn hàng</h3>
                                </div>
                                {this.renderOrder()}
                            </div>
                        </div>  
